...
def get_args():
    ...
    parser.add_argument("--model_id", type=str, default="llamacode-7b")
    ...
    parser.add_argument("--output_dir", type=str, default="finetune_llamacode-7b_clean")
    parser.add_argument("--num_proc", type=int, default=None)

    parser.add_argument("--backdoor", type=float, default=0.1)
    parser.add_argument("--backdoor_code_type", type=int, default=0)
    parser.add_argument("--model_path", type=str, default="/home/xukaiyuan/Project/backdoor_code/CodeLlama-7b-hf")
    # Parse arguments
